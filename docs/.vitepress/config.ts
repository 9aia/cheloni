...
export default defineConfig({
  ...
  title: "Cheloni",
  description:
    "A modern, type-safe CLI framework for TypeScript. Build command-line tools with full type inference, Zod validation, and a powerful plugin system.",
  themeConfig: {
    ...
    sidebar: {
      "/guides/": [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "Defining Positional Args",
              link: "/guides/essentials/defining-positional-args",
            },
            {
              text: "Creating Command Handlers",
              link: "/guides/essentials/creating-command-handlers",
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "Creating Reusable Options",
              link: "/guides/advanced/creating-reusable-options",
            },
      ...
      "/reference/": [
        ...
        {
          text: "CLI Reference",
          items: [{ text: "CLI", link: "/reference/cli/index" }],
        },
      ],
      "/explanation/": [
        {
          ...
          items: [
            ...
            {
              text: "Throw on Extrageous Options",
              link: "/explanation/throw-on-extrageous-options",
            },
    ...
    socialLinks: [{ icon: "github", link: "https://github.com/9aia/cheloni" }],
  },
});
