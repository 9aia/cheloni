import{_ as s,o as a,c as n,ai as e}from"./chunks/framework.Bm4BMKaq.js";const k=JSON.parse('{"title":"Creating CLI","description":"","frontmatter":{},"headers":[],"relativePath":"guides/creating-cli.md","filePath":"guides/creating-cli.md"}'),t={name:"guides/creating-cli.md"};function l(r,i,h,p,o,d){return a(),n("div",null,[...i[0]||(i[0]=[e(`<h1 id="creating-cli" tabindex="-1">Creating CLI <a class="header-anchor" href="#creating-cli" aria-label="Permalink to “Creating CLI”">​</a></h1><h2 id="best-practices" tabindex="-1">Best Practices <a class="header-anchor" href="#best-practices" aria-label="Permalink to “Best Practices”">​</a></h2><h3 id="file-structure" tabindex="-1">File Structure <a class="header-anchor" href="#file-structure" aria-label="Permalink to “File Structure”">​</a></h3><p><strong>Do</strong>: Organize commands in separate files and import them into a single <code>manifest.ts</code>.</p><pre><code>For bigger projects, we suggest organizing commands in separate files and import them into a single \`manifest.ts\`.
